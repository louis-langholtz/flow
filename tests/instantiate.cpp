...
TEST(instantiate, bin_sleep)
{
    ...
    auto sys = flow::system{system::custom{
        .subsystems = {{exe_name, {
            ...
            },
            {
                ...
                {signals::info(), {"puts progress info on stderr", io_type::in}},
            }
        }}},
    ...
    }};
    {
        ...
        send_signal(signals::info(), instance, std::cerr);
        ...
        while (linenum < 3) {
            ...
            if (c == '\n') {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    EXPECT_NE(os.str().find("bytes transferred"), std::string::npos);
                    break;
                }
                os.str(std::string{});
            }
